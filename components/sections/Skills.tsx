          ...
          {skills
            ...
            ?.items.map((item, i) => (
              <motion.div
                ...
                className="bg-white/[0.02] border border-white/5 p-10 flex flex-col items-center justify-center text-center group cursor-default hover:border-white/20 hover:bg-white/[0.04] transition-all duration-500 rounded-sm w-44 h-44"
              >
